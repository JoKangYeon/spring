    ...
    <form action="memberRegist.wow" method="post">
        <table class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <button class="btn btn-primary" type="button" id="idCheck">중복확인</button></td>
            </tr>
            <tr>
                <th>비밀번호</th>
            ...
            <tr>
                ...
                <td><input type="email" name="memMail" class="form-control input-sm">
                    <button class="btn btn-primary" type="button" id="emailCheck">이메일체크</button></td></td>
            </tr>
            <tr>
                <th>핸드폰</th>
...
<script>
    $(document).ready(function () { // html 전부 만들어 지고 나서
        // id가 빈 값이면 버튼클릭 시  아무일도 일어나지 않음
        // id가 값이 있으면 버튼 클릭 시 서버에 ajax 요청.
        // 서버에서는 id가 DB에 있는지 확인. 있으면 false 없으면 ture
        //  없을때 alert(사용가능 아이디), 있을 때 alert(이미 존재하는 id)
